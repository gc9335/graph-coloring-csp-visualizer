...
def test_plot_from_csv_generates_grouped_artifacts(tmp_path: Path):
    ...
    rows = [
        ...
        make_row(experiment_group="multi_solution_25", dataset="le450_25a.col", variant="B0", declared_classes=25, color_limit=25, solution_target=1, solutions_found=1, runtime_seconds=0.1, node_expansions=50),
        make_row(experiment_group="multi_solution_25", dataset="le450_25a.col", variant="B0", declared_classes=25, color_limit=25, solution_target=1000, solutions_found=1000, runtime_seconds=4.0, node_expansions=500),
        make_row(experiment_group="multi_solution_25", dataset="le450_25a.col", variant="B5", declared_classes=25, color_limit=25, solution_target=1, solutions_found=1, runtime_seconds=0.2, node_expansions=40),
        make_row(experiment_group="multi_solution_25", dataset="le450_25a.col", variant="B5", declared_classes=25, color_limit=25, solution_target=1000, solutions_found=1000, runtime_seconds=3.5, node_expansions=450),
    ]
    csv_path.write_text(
        "\n".join(
            [
